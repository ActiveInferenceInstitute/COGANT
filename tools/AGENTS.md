...
| [`regenerate_metrics.py`](regenerate_metrics.py) | Regenerates `cogant/evaluation/METRICS.yaml` from the live repo (pytest, mypy, ruff, coverage.json, AST walk, roundtrip JSONL). Directory-independent; paths anchored on `__file__`. |
