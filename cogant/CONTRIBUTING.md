...
The test suite has **2,146 passing tests** and should complete in under two minutes on a
modern laptop. Coverage is currently **87%**; new code should keep or improve that.
mypy strict mode reports **0 errors**. Ruff has 27 open violations (UP038, cosmetic).
...
Authoritative metrics are in `cogant/evaluation/METRICS.yaml` (regenerated by
