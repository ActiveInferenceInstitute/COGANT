# Agents - examples/control_positive/calculator

## Scope

Calculator Fixture. This fixture exercises small arithmetic functions, config values, and assertion-like constraints for fast local pipeline and
roundtrip evidence.

## Files

- `calculator.py` - primary fixture source.
