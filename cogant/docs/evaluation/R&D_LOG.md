...
>
> **Current state (2026-05-09, wave-21):** v0.5.0 · **9,222 tests passing** (0 failing, 31 skipped, 9,253 total) ·
> **96.22% coverage** · 0 mypy strict errors · 0 ruff violations · roundtrip **23/23 ISOMORPHIC**
> at ε ≥ 0.8 (mean ε = 1.0) · 22 translation rules (5 structural + 5 semantic + 3 control + 4 behavioral + 5 resilience) · 204 Python source files · 167 public modules · 401 public classes · 1,047 public functions.
>
