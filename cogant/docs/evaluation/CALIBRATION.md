...
All 19 translation rules share a flat priority of 0 and are resolved
...
**Goal:** validate that the 0.65–0.90 band assignment across 19 rules
...
- **Implementing modules:**
  ...
  [`py/cogant/translate/rules/`](https://github.com/cogant-contributors/cogant/blob/main/py/cogant/translate/rules/) (19 rules across semantic/structural/behavioral/control/resilience),
