...
- **Implementing modules:**
  [`py/cogant/reverse/synthesizer.py`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/py/cogant/reverse/synthesizer.py) (`_render_constraints_module`),
  [`py/cogant/reverse/planner.py`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/py/cogant/reverse/planner.py) (`plan.constraint_checks`),
  [`py/cogant/translate/rules/semantic.py`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/py/cogant/translate/rules/semantic.py) (`PreferenceRule`)
