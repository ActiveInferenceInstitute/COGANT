...
- [`evaluation/METRICS.yaml`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/evaluation/METRICS.yaml)
- [`evaluation/dataset/roundtrip_results.jsonl`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/evaluation/dataset/roundtrip_results.jsonl)
