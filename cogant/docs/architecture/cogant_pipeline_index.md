...
- **[examples/example_pipeline.py](https://github.com/docxology/cogant/blob/main/cogant/examples/example_pipeline.py)** - Runnable API example
- **[tests/integration/test_pipeline_runner_e2e.py](https://github.com/docxology/cogant/blob/main/cogant/tests/integration/test_pipeline_runner_e2e.py)** - Integration tests
