...
| [GNN format reference](gnn_format_reference.md) | Working reference for the 18 sections in a GNN package | Advanced |
...
5. [GNN format reference](gnn_format_reference.md) — exhaustive reference for the 18-section package layout.
