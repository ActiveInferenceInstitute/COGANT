...
- **Zoo:** [`examples/zoo/04_pomdp_minimal/`](https://github.com/docxology/cogant/tree/main/cogant/examples/zoo/04_pomdp_minimal) — smallest target that meaningfully exercises every stage in the default `stages=[...]` list.
- **Zoo:** [`examples/zoo/12_full_pomdp/`](https://github.com/docxology/cogant/tree/main/cogant/examples/zoo/12_full_pomdp) — full pipeline integration target including `process` and `validate` stages.
