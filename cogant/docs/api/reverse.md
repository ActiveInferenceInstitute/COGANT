...
- **Zoo:** [`examples/zoo/01_simple_state/`](https://github.com/ActiveInferenceInstitute/COGANT/tree/main/cogant/examples/zoo/01_simple_state) — round-trip target with the smallest non-trivial `MatrixFunctions` closure.
- **Zoo:** [`examples/zoo/04_pomdp_minimal/`](https://github.com/ActiveInferenceInstitute/COGANT/tree/main/cogant/examples/zoo/04_pomdp_minimal) — A/B/C/D round-trip used by `verify_repo_roundtrip`.
- **Zoo:** [`examples/zoo/13_js_observer/`](https://github.com/ActiveInferenceInstitute/COGANT/tree/main/cogant/examples/zoo/13_js_observer) — cross-language reverse target (JS → GNN → Python package).
