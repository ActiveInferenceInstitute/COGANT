...
- **Zoo:** [`examples/zoo/01_simple_state/`](../../examples/zoo/01_simple_state/) — produces the smallest valid `GNNPackage` (1 hidden state, 0 observations).
- **Zoo:** [`examples/zoo/04_pomdp_minimal/`](../../examples/zoo/04_pomdp_minimal/) — produces a complete A / B / C / D quadruple via the matrix builder.
- **Zoo:** [`examples/zoo/12_full_pomdp/`](../../examples/zoo/12_full_pomdp/) — full validator score = 100 / 100 reference.
