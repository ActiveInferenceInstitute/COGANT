...
- **Zoo:** [`examples/zoo/01_simple_state/`](https://github.com/cogant-contributors/cogant/tree/main/cogant/examples/zoo/01_simple_state) — exercises `HiddenStateRule` (semantic family).
...
- **Zoo:** [`examples/zoo/03_actor/`](https://github.com/cogant-contributors/cogant/tree/main/cogant/examples/zoo/03_actor) — exercises `ActionRule` (behavioral).
- **Zoo:** [`examples/zoo/09_policy/`](https://github.com/cogant-contributors/cogant/tree/main/cogant/examples/zoo/09_policy) — exercises `PolicyRule` (control-flow).
