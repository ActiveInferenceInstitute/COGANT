...
- **Zoo:** [`examples/zoo/01_simple_state/`](https://github.com/cogant-contributors/cogant/tree/main/cogant/examples/zoo/01_simple_state) — single-file target with one class and three methods (smallest static run).
- **Zoo:** [`examples/zoo/06_hierarchical/`](https://github.com/cogant-contributors/cogant/tree/main/cogant/examples/zoo/06_hierarchical) — multi-class hierarchy that exercises symbol resolution and call-graph edges.
- **Zoo:** [`examples/zoo/11_sensor_fusion/`](https://github.com/cogant-contributors/cogant/tree/main/cogant/examples/zoo/11_sensor_fusion) — multi-module imports + dataflow patterns.
