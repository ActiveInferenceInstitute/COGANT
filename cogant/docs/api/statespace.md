...
- **Zoo:** [`examples/zoo/01_simple_state/`](https://github.com/ActiveInferenceInstitute/COGANT/tree/main/cogant/examples/zoo/01_simple_state) — single-variable state space, smallest possible compiler input.
- **Zoo:** [`examples/zoo/05_multi_factor/`](https://github.com/ActiveInferenceInstitute/COGANT/tree/main/cogant/examples/zoo/05_multi_factor) — multi-factor state space exercising the variable builder's domain inference.
- **Zoo:** [`examples/zoo/07_event_driven/`](https://github.com/ActiveInferenceInstitute/COGANT/tree/main/cogant/examples/zoo/07_event_driven) — event-driven temporal patterns the temporal helpers normalize.
