...
- **Zoo:** [`examples/zoo/01_simple_state/`](../../examples/zoo/01_simple_state/) — single-variable state space, smallest possible compiler input.
- **Zoo:** [`examples/zoo/05_multi_factor/`](../../examples/zoo/05_multi_factor/) — multi-factor state space exercising the variable builder's domain inference.
- **Zoo:** [`examples/zoo/07_event_driven/`](../../examples/zoo/07_event_driven/) — event-driven temporal patterns the temporal helpers normalize.
