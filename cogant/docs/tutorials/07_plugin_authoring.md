...
- [`py/cogant/plugins/base.py`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/py/cogant/plugins/base.py) — the full base-class API.
- [`py/cogant/parsers/tree_sitter_base.py`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/py/cogant/parsers/tree_sitter_base.py) —
