...
those long-tail kinds is tracked as P1-2 / P1-3 in [`../evaluation/SCOPING_REPORT.md`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/docs/evaluation/SCOPING_REPORT.md).
