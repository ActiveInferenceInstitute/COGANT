...
sketch is in
[`../evaluation/ISOMORPHISM_THEOREM.md`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/docs/evaluation/ISOMORPHISM_THEOREM.md),
...
Tracked in [`../evaluation/SCOPING_REPORT.md § reverse`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/docs/evaluation/SCOPING_REPORT.md#reverse) and
[`../evaluation/R&D_LOG.md`](https://github.com/ActiveInferenceInstitute/COGANT/blob/main/cogant/docs/evaluation/R&D_LOG.md):
