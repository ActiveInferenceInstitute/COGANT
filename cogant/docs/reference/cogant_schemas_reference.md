...
`REPO`, `MODULE`, `FILE`, `PACKAGE`, `CLASS`, `FUNCTION`, `METHOD`, `VARIABLE`, `FIELD`, `ENDPOINT`, `EVENT`, `TEST`, `BUILD_TARGET`, `PROCESS`, `THREAD`, `STORAGE`, `EXTERNAL_DEP`.

#### `EdgeKind` (enum, 18 relations)

`CONTAINS`, `IMPORTS`, `DEFINES`, `CALLS`, `CONSTRUCTS`, `INHERITS`, `IMPLEMENTS`, `READS`, `WRITES`, `MUTATES`, `EMITS`, `OBSERVES`, `PERSISTS_TO`, `SUBSCRIBES_TO`, `PUBLISHES_TO`, `GUARDS`, `TESTS`, `DEPENDS_ON`.
