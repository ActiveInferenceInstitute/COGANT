...
- **Multi-language support (roadmap)** — Python is the primary focus at v0.1.x; Java, JavaScript, Rust, and C/C++ are design targets as front-ends mature (see [Implementation status](#implementation-status) and the [README](../README.md) honest-scope section).
