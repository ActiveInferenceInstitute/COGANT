...
- **Multi-language support (roadmap)** — Python is the primary focus at v0.1.x; Java, JavaScript, Rust, and C/C++ are design targets as front-ends mature (see [Implementation status](implementation_status.md#implementation-status) and the [README](https://github.com/cogant-contributors/cogant/blob/main/cogant/README.md) honest-scope section).
