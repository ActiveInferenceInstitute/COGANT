#!/usr/bin/env python3
"""Coverage boost batch 17 — server internals and statespace compiler.
...
def real_server_app():
    """Remove any stub for cogant.server.app injected by test_server_models_cov.py.

    test_server_models_cov.py injects a lightweight stub into sys.modules so that
