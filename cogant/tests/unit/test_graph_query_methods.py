"""Targeted unit tests for: cogant.graph.queries.

Covers the methods left uncovered by ``test_graph_queries_behavior.py``:
...
Style mirrors ``test_graph_queries_behavior.py``.
"""
