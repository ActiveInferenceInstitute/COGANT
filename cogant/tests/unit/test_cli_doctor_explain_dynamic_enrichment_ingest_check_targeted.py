#!/usr/bin/env python3
"""Targeted branch tests — cli/doctor.py, cli/explain.py pure functions,
...
class TestDoctorReport:
    ...
    def test_report_with_warn(self):
        from cogant.cli.doctor import DoctorCheck, DoctorReport
...
class TestDoctorChecks:
    ...
    def test_render_report_produces_output(self):
        ...
        from cogant.cli.doctor import render_report, run_doctor
...
class TestResolveNode:
    ...
    def test_resolve_not_found_raises(self):
        from cogant.cli.explain import NodeNotFoundError, resolve_node
...
class TestEnrichmentHelpers:
    ...
    def test_node_spans_line_in_range(self):
        ...
        node = types.SimpleNamespace(source_range={"start_line": 5, "end_line": 15})
    ...
    def test_node_spans_line_nested_dict(self):
        ...
        node = types.SimpleNamespace(source_range={"start": {"line": 3}, "end": {"line": 7}})
        assert _node_spans_line(node, 5) is True
