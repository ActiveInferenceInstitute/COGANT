#!/usr/bin/env python3
"""Targeted branch tests: simulate/runner.py, viz/boundary.py, viz/graph_view.py,
...
class TestRoundtripResult:
    def test_summary_isomorphic(self):
        ...
        assert "role_preservation=85.00%" in summary
    ...
    def test_summary_not_isomorphic(self):
        ...
        assert "role_preservation=30.00%" in summary
