...
during the April 2026 mutation sweep. Each test targets a specific
...
def _make_graph() -> ProgramGraph:
    return ProgramGraph(metadata=GraphMetadata(repo_uri="targeted-test"))
