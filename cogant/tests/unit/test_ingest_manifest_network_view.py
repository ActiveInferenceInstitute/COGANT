"""Targeted unit tests for cogant.ingest.manifest and cogant.viz.network_view.
...
network_view.py:
    - ``plot_hotspot_treemap`` body (lines 282-314). The dependency
      ...
      ImportError fallback is the only path covered by parameter/state/rate-limit. We
...
# Match the project import pattern used by sibling targeted tests.
