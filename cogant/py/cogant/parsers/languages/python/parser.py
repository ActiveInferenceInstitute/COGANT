...
from cogant.parsers._base import CogantLanguagePlugin  # noqa: E402
...
class PythonLanguageParser(CogantLanguagePlugin):
    ...
    def extract_types(self, ast: dict[str, Any]) -> dict[str, Any]:
        ...
        """
        types: dict[str, list[dict[str, Any]]] = {"classes": [], "functions": [], "variables": []}
    ...
    def _assignment_to_dict(self, assign: Any) -> dict[str, Any]:
