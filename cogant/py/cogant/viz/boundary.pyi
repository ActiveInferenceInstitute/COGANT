...
class BoundaryMapper:
    ...
    def markov_blanket_collapsed_mermaid(self, graph: ProgramGraph, blanket: Any = None, *, strategy: str = 'auto', **extract_kwargs: Any) -> str: ...
    def markov_blanket_detailed_mermaid(self, graph: ProgramGraph, blanket: Any = None, *, strategy: str = 'auto', max_per_role: int = 12, **extract_kwargs: Any) -> str: ...
