...
class ReviewManager:
    ...
    def accept_mapping(
        self, mapping_id: str, reviewer: str, feedback: str | None = None
    ) -> bool: ...
    ...
    def split_mapping(
        self, mapping_id: str, reviewer: str, split_definitions: list[dict[str, Any]]
    ) -> list[str]: ...
    def merge_mappings(
        self, mapping_ids: list[str], reviewer: str, merged_definition: dict[str, Any]
    ) -> str | None: ...
