...
class ConfidenceModel:
    ...
    def determine_confidence_tier(
        self, mapping: SemanticMapping, score: float | None = None
    ) -> ConfidenceTier: ...
    ...
    def get_high_confidence_mappings(
        self, mappings: list[SemanticMapping], threshold: float = 0.7
    ) -> list[SemanticMapping]: ...
    def get_low_confidence_mappings(
        self, mappings: list[SemanticMapping], threshold: float = 0.6
    ) -> list[SemanticMapping]: ...
