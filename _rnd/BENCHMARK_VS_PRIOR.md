...
`_rnd/CALIBRATION.md` and `benchmarks/results/suite_20260409.md` from the
same audit date.
...
knowledge that COGANT's 19 translation rules capture (see
...
`_rnd/CALIBRATION.md` section 2.1. The 19 translation rules are organized
...
3. **tree-sitter and pyan baselines are intentionally weak.** We compare
   ...
   tested rule system (19 rules across 5 families: semantic, structural,
...
- `_rnd/CALIBRATION.md` -- parameter registry and calibration backlog
- `benchmarks/results/suite_20260409.md` -- timing and mapping counts
- `py/cogant/translate/rules/` -- 19 translation rules across 5 families
