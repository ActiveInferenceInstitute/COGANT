...
*Document maintained in `projects_in_progress/cogant/_rnd/`. Theory reference: `ISOMORPHISM_THEOREM.md`. Test implementation: `tests/infra_tests/test_roundtrip.py` (to be written). Script: `scripts/run_roundtrip_validation.py` (to be written).*
