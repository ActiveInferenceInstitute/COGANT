...
| C — Operations and reproducibility | CI, packaging, validation | Config, tests, coverage table, recording | @sec:06-experimental-setup and @sec:07-reproducibility |
...
|-----|------|--------------|
| `docs/index.md` | Entry and quick links | First visit |
| `docs/api/README.md` | Session, `PipelineRunner`, `Bundle`, `ReviewAPI` | Programmatic use |
| `docs/cli/README.md` and `docs/cli_reference.md` | Commands and flags | Shell / automation |
| `docs/export/README.md` | GNN schema, tensor interop | Downstream consumers |
| `docs/plugins/README.md` | Parsers, rules, validators, exporters | Extensions |
| `docs/architecture/README.md` | Layers, crates, data flow | System picture |
| `docs/reference/README.md` | Implementation status, how-tos | Onboarding, scope |
| `docs/rules/README.md` | Translation rules | Rule authors |
| `docs/validation/README.md` | Integrity and provenance | Quality gates |
| `docs/security/README.md` | Threat model, sandboxing | Deployment |
| `docs/roadmap/README.md` | Releases and backlog | Planning |
| `specs/README.md` | Machine-readable IR contracts | Integrators |
| `docs/reference/documentation_modules.md` | Full `docs/<module>` index | Deep navigation |
