...
| Interoperability | @fig:cogant-gnn-markdown-render | Can the emitted GNN artifact be inspected as a structured bundle? | Format and internal export compatibility, not semantic adequacy or upstream execution. |
