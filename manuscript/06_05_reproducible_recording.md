...
All numbers in Tables 4–7 of @sec:06-03-performance-and-fixture-metrics and in the benchmark suite of @sec:06-04-tests-mutation-and-benchmarks are regenerated by two scripts that live inside the COGANT package tree and take no arguments beyond a `--output` directory:
