...
The [parent-template manuscript discovery implementation](https://github.com/docxology/template/blob/main/infrastructure/rendering/manuscript_discovery.py) concatenates:
